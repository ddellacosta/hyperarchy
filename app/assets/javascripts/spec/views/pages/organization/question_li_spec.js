...
describe("Views.Pages.Organization.QuestionLi", function() {
  ...
  beforeEach(function() {
    attachLayout();
    creator = User.created({id: 1, emailHash: "email-hash"});
    question = Question.created({id: 1, body: "What's your *favorite* color?", creatorId: creator.id()});
    answer1 = question.answers().created({id: 1, body: "*Red*", position: 1});
    answer2 = question.answers().created({id: 2, body: "Blue", position: 2});
