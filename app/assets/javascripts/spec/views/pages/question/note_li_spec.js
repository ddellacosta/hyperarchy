...
describe("Views.Pages.Question.NoteLi", function() {
  var currentUser, question, note, creator, noteLi, noteEditableByCurrentUser;
  ...
  beforeEach(function() {
    ...
    note = question.notes().createFromRemote({id: 11, body: "I likeah the fruiloops so much", creatorId: creator.id(), createdAt: 3245});
    spyOn(note, 'editableByCurrentUser').andCallFake(function() {
      return noteEditableByCurrentUser;
    });

    noteLi = Views.Pages.Question.NoteLi.toView({note: note});
  });
