...
//      this.rankingsSubscriptions.add(this.rankings().onRemove(this.hitch('removeRanking')));
    ...
    insertRankingLi: function(agendaItem, options) {
      ...
      if (rankingLi) {
        ...
        rankingLi = Views.Pages.Meeting.RankingLi.toView({agendaItem: agendaItem});
    ...
    findOrCreateLi: function(ranking) {
      ...
      if (!this.lisByAgendaItemId[id]) this.lisByAgendaItemId[id] = Views.Pages.Meeting.RankingLi.toView({ranking: ranking});
