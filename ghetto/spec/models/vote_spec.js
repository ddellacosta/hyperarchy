...
describe("Vote", function() {
  ...
  beforeEach(function() {
    ...
    vote = user.votes().createFromRemote({id: 1, meetingId: 33, updatedAt: 1308353647242});
  });
  ...
  describe("#url", function() {
    it("returns the correct url", function() {
      attachLayout();
      expect(vote.url()).toEqual('/meetings/33/votes/1');

      Application.currentUser(user);

      expect(vote.url()).toEqual('/meetings/33');
    });
  });
});
