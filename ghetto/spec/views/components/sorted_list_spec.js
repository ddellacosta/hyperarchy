  ...
  beforeEach(function() {
    view = Views.Components.SortedList.toView({
      buildElement: function(agendaItem) {
        return $("<li>" + agendaItem.body() + "</li>");
      }
    });

    var meeting = Meeting.createFromRemote({id: 1, body: "What's your favorite color?"});
    relation = meeting.agendaItems();
    ...
    var meeting2 = Meeting.createFromRemote({id: 2, body: "What's your favorite type of car?"});
    relation2 = meeting2.agendaItems();
