...
describe("Views.Lightboxes.FullScreenAgendaItem", function() {
  var fullScreenAgendaItem, team, creator, meeting, agendaItem1, agendaItem2, agendaItem3;
  ...
  beforeEach(function() {
    ...
    agendaItem1 = creator.agendaItems().createFromRemote({id: 1, position: 1, meetingId: 1, body: "meetingmapper.us", createdAt: 123});
    agendaItem2 = creator.agendaItems().createFromRemote({id: 2, position: 2, meetingId: 1, body: "actionitems.us", createdAt: 124});
    agendaItem3 = creator.agendaItems().createFromRemote({id: 3, position: 3, meetingId: 1, body: "agileplanner.co", createdAt: 125});
  ...
  describe("when the 'back to list' link is clicked", function() {
    it("navigates to the full screen consensus view", function() {
      ...
      expect(Path.routes.current).toBe(meeting.fullScreenUrl());
    });
  });
