...
describe("Views.Pages.Meeting.VoteLi", function() {
  var voteLi, vote, user, meeting;
  beforeEach(function() {
    user = User.createFromRemote({id: 1, firstName: 'joe', lastName: 'henderson'});
    meeting = Meeting.createFromRemote({id: 1, creatorId: 1, createdAt: 234234});
    vote = user.votes().createFromRemote({meetingId: meeting.id(), updatedAt: 1308352736162});
    voteLi = Views.Pages.Meeting.VoteLi.toView({vote: vote});
  });
