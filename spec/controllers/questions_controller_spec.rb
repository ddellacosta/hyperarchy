...
describe QuestionsController do
  ...
  describe "#index" do
    ...
    context "if authenticated as a default guest" do
      it "only allows the user to read questions from publicly readable teams" do
    ...
    context "if authenticated as a member" do
      ...
      it "allows the user to read questions from publicly readable teams and teams they are members of" do
        perform_get(private_org)
        response.should be_forbidden
