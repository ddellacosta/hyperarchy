...
Screw.Unit(function(c) { with(c) {
  describe("Relations.Selection", function() {
    ...
    before(function() {
      operand = User.table;
      predicate = new OldMonarch.Model.Predicates.Eq(User.age, 31);
      selection = new OldMonarch.Model.Relations.Selection(operand, predicate);
    });
    ...
    describe("event handling", function() {
      ...
      context("when a signal upon which the selection is based changes in value", function() {
