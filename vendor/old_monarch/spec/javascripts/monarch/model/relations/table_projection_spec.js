...
Screw.Unit(function(c) { with(c) {
  describe("OldMonarch.Model.Relations.TableProjection", function() {
    ...
    init(function() {
      ...
      post1 = blog1.blogPosts().createFromRemote({id: 2, body: "this is post 1"});
      post2 = blog1.blogPosts().createFromRemote({id: 3, body: "this is post 2"});
      post3 = blog2.blogPosts().createFromRemote({id: 1, body: "this is post 3"});
