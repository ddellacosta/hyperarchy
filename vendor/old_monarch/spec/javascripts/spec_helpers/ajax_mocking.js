Screw.Unit(function(c) {
  c.mockAjax = function(autoInteract) {
    c.init(function() {
      window.requests = [];
      c.mock(jQuery, 'ajax', function(request) {
  ...
  c.mockLowLevelXhr = function() {
    c.before(function() {
      window.requests = [];
      c.mock(jQuery.ajaxSettings, 'xhr', function() {
        var newXhr = new FakeXMLHttpRequest();
        window.requests.push(newXhr);
        return newXhr;
      })
    });
