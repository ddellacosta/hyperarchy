_.constructor("OldMonarch.Http.FakeServer", OldMonarch.Http.Server, {
  ...
  fetch: function() {
    var fakeFetch = new OldMonarch.Http.FakeServer.FakeFetch(Repository.sandboxUrl, _.flatten(arguments), this);
    if (this.auto) {
  ...
  create: function(record) {
    var fakeCreation = new OldMonarch.Http.FakeServer.FakeCreation(this, record);
    if (this.auto) {
  ...
  update: function(record) {
    var fakeUpdate = new OldMonarch.Http.FakeServer.FakeUpdate(this, record);
    if (this.auto) {
  ...
  destroy: function(record) {
    var fakeDestruction = new OldMonarch.Http.FakeServer.FakeDestruction(this, record);
    if (this.auto) {
  ...
  subscribe: function(relations) {
    var fakeSubscribe = new OldMonarch.Http.FakeServer.FakeSubscribe(Repository.sandboxUrl, relations, this);
  ...
  unsubscribe: function(remoteSubscriptions) {
    var fakeUnsubscribe = new OldMonarch.Http.FakeServer.FakeUnsubscribe(Repository.sandboxUrl, remoteSubscriptions, this);
  ...
  request: function(type, url, data) {
    var fakeRequest = new OldMonarch.Http.FakeServer.FakeRequest(type, url, data, this);
